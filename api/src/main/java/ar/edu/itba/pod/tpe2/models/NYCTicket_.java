...
public class NYCTicket_ extends Ticket<Integer, Double, LocalDate> {
    public NYCTicket_() {
        //Hazelcast
    }

    public NYCTicket_(String plate, LocalDate issueDate, Integer infractionCode, Double fineAmount, String countyName, String issuingAgency) {
